...
public class Presentation extends MainActivity implements SteerActionReceiver, CircleLayout.OnItemSelectedListener, CircleLayout.OnItemClickListener, CircleLayout.OnRotationFinishedListener, CircleLayout.OnCenterClickListener {
    ...
    public void Rotatorui()
    {
        ...
        if (rotator.equals("Circular")) {
            ...
            View contentView = inflater.inflate(R.layout.presentationr, null, false);
        ...
        else
        {
            ...
            fabIconStar.setImageDrawable(getResources().getDrawable(R.drawable.home_ppt));
...
//            lCSubBuilder.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_action_blue_selector));
            ...
            lcIcon1.setImageDrawable(getResources().getDrawable(R.drawable.ppt_start));
            lcIcon2.setImageDrawable(getResources().getDrawable(R.drawable.ppt_pen));
            lcIcon3.setImageDrawable(getResources().getDrawable(R.drawable.ppt_laser));
            lcIcon4.setImageDrawable(getResources().getDrawable(R.drawable.ppt_stop));
            lcIcon5.setImageDrawable(getResources().getDrawable(R.drawable.ppt_left));
            lcIcon6.setImageDrawable(getResources().getDrawable(R.drawable.ppt_right));
