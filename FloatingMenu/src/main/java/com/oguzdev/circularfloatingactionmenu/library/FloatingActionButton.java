...
public class FloatingActionButton extends FrameLayout {
     ...
     * @param contentParams
     */
    public FloatingActionButton(Activity activity, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, int position, View contentView, FrameLayout.LayoutParams contentParams, ViewGroup containerView) {
        super(activity);
...
//            this.backgroundDrawable = backgroundDrawable;
        ...
        public Builder setBackgroundDrawable(int drawableId) {
            return null;
//                    setBackgroundDrawable(activity.getResources().getDrawable(drawableId));
        }
